...
# using llama-2-13b 
torchrun --nproc_per_node 2 examples/ljspeech_examples/example_text_completion_emo_mat_text_onehour.py \
    --ckpt_dir llama-2-13b/ \
    --tokenizer_path tokenizer.model \
    --max_seq_len 256 --max_batch_size 50 ;

torchrun --nproc_per_node 2 examples/ljspeech_examples/example_text_completion_emo_mat_text_tenmin.py \
    --ckpt_dir llama-2-13b/ \
    --tokenizer_path tokenizer.model \
    --max_seq_len 256 --max_batch_size 50
