...
output_file_name = 'semantics_last'

input_file = '/data/espnet/egs2/libritts/tts1/data/train-clean-100/text_split_2'
output_file = f"/data/espnet/egs2/libritts/tts1/dump/raw/train-clean-100_phn/{output_file_name}_temp_2.pt"
...
def main(
    ...
    max_seq_len: int = 256,
    max_gen_len: int = 64,
    max_batch_size: int = 25, # 本文件中每次最大输入的句子数
):
